// ======================================================================
// H Eindopdracht.v generated from TopDesign.cysch
// 01/05/2021 at 00:15
...
module top ;
	...
	wire [4:0] tmpOE__Pin_1_net;
	wire [4:0] tmpFB_4__Pin_1_net;
	wire [4:0] tmpIO_4__Pin_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_1
		 (.oe(tmpOE__Pin_1_net),
		  .y({5'b0}),
		  .fb({tmpFB_4__Pin_1_net[4:0]}),
		  .io({tmpIO_4__Pin_1_net[4:0]}),
		  .siovref(tmpSIOVREF__Pin_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1_net[0:0]}),
		  .annotation({Net_20, Net_34, Net_18, Net_31, Net_16}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{5'b11111} : {5'b11111};
	...
	cy_psoc3_pins_v1_10
		#(.id("8e677156-cba2-4f18-b74b-6aaea8c6164a"),
		  .drive_mode(15'b110_110_110_110_110),
		  .ibuf_enabled(5'b1_1_1_1_1),
		  .init_dr_st(5'b0_0_0_0_0),
		  .input_clk_en(0),
		...
		Pin_2
		 (.oe(tmpOE__Pin_2_net),
		  ...
		  .annotation({Net_29, Net_41, Net_27, Net_38, Net_25}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_psoc3_pins_v1_10
		#(.id("a5c16bc0-9e51-4102-8858-260cdcc30551"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
